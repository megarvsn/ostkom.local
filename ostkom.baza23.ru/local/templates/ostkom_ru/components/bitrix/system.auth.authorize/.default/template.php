...
global $LangId;
__IncludeLang($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/ostkom/components/bitrix/system.auth.authorize/.default/lang/".$LangId."/template.php");
?>
<div class="bx-auth">
...
<?endif?>
	...
	<div class="account-form__title h5"><?=GetMessage("AUTH_PLEASE_AUTH")?></div>
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<table class="bx-auth-table">
			<tr>
				...
				<td><input class="input" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" /></td>
			</tr>
			<tr>
				<td class="bx-auth-label"><?=GetMessage("AUTH_PASSWORD")?></td>
				<td><input class="input" type="password" name="USER_PASSWORD" maxlength="255" autocomplete="off" />
