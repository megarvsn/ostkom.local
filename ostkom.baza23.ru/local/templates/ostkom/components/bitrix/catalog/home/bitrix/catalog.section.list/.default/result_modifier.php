...
if (0 < $arResult['SECTIONS_COUNT'])
{
	...
	if ($boolPicture || $boolDescr)
	{
		...
		foreach ($arResult['SECTIONS'] as $key => $arSection)
		{
            $section_props = CIBlockSection::GetList(array(), array('IBLOCK_ID' => $arSection['IBLOCK_ID'] , 'ID' => $arSection['ID']), true, array("IBLOCK_ID","ID","UF_ADD_TEXT","UF_IMAGE","UF_ANONS"));
...
//echo"<pre>";	print_r($props_array);	echo"</pre>";				
		}	
}
?>