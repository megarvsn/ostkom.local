...
global $LangId;
global $str_name;
__IncludeLang($_SERVER["DOCUMENT_ROOT"]."/bitrix/templates/ostkom/components/bitrix/news/actions/bitrix/news.detail/.default/lang/".$LangId."/template.php");
$str_name=GetMessage("NAME")." ".$arResult['NAME'];
