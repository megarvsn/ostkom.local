(function (window) {
    ...
    if (window.jsc_AJAX_ProfileForm) return;

    window.jsc_AJAX_ProfileForm = function (arParams) {
        this.scriptUrl = '';
        this.ajaxUrl = '';
        this.formId = '';
        ...
        if (this.errorCode === 0) {
            ...
            console.log('jsc_AJAX_ProfileForm errorCode =', this.errorCode);
        }
    };

    window.jsc_AJAX_ProfileForm.prototype = {
        init: function () {
