...
if ($arAFParams["MODAL"]["IBLOCK_FORM_SECTION_CODE"]) {
    $arFormAttrs = \Baza23\Settings::psf_form_all($arAFParams["MODAL"]["IBLOCK_FORM_SECTION_CODE"]);
}
...
?><div id="<?= \Baza23\AuthForms::AF_MODAL_FORM_CSS_ID ?>" class="form-wrapper maf-success"><?
    if ($text) {
...
?></div><? // class="form-wrapper maf-success"
