...
let jso_html_multiSelectCss = {
    ...
    jsf_toggleContent: function(p_elem) {
        if ($(p_elem).hasClass('select-active')) {
            ...
            jso_html_multiSelectCss.jsf_hideAll();
            jso_html_multiSelectCss.jsf_showContent(p_elem);
        }
    },
    ...
    jsf_hideAll: function() {
        jso_html_multiSelectCss.jsf_hideContent('.form--select');
    },
