...
if ($arWFParams["IBLOCK_FORM_SECTION_CODE"]) {
    $arFormAttrs = \Baza23\Settings::psf_form_all($arWFParams["IBLOCK_FORM_SECTION_CODE"]);
}
...
?><div id="<?= \Baza23\WebForms::WF_MODAL_FORM_CSS_ID ?>" class="form-wrapper wf-success"><?
    if ($text) {
...
?></div><? // class="form-wrapper wf-success"
...
$arRes = [
    ...
    "AJAX" => "Y",
    "WEB_FORM" => "Y",
    "TYPE" => \Baza23\WebForms::WF_MODAL_FORM_CSS_ID,
    "TITLE" => $titleHtml,
