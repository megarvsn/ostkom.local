(function (window) {
    ...
    if (window.jsc_AJAX_WebForm) return;

    window.jsc_AJAX_WebForm = function (arParams) {
        this.scriptUrl = '';
        this.ajaxUrl = '';
        this.formId = '';
        ...
        if (this.errorCode === 0) {
            ...
            console.log('jsc_AJAX_WebForm errorCode =', this.errorCode);
        }
    };

    window.jsc_AJAX_WebForm.prototype = {
        init: function () {
