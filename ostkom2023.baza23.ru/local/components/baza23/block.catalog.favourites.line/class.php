...
class PC_BLOCK_CatalogFavouritesLine extends CBitrixComponent {
    /**
    ...
    public function onPrepareComponentParams($p_arParams) {
        ...
        $p_arParams["FAVOURITES_PATH"] = trim($p_arParams["FAVOURITES_PATH"]);
    ...
    public function executeComponent() {
        ...
        $this->arResult["PRODUCT_IDS"] = \Baza23\CatalogFavourites::psf_getProductIds();
